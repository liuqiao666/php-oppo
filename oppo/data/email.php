<?php 
	...
	$mailbody="Hi ".$mailto." This is a test email from Liu Qiao 邮箱验证： http://localhost/oppo/data/checkemail.php?email=".$mailto." 密码找回： http://localhost/oppo/oppo_lookpassword.php?email=".$mailto;  
	...
	fwrite($fp,"DATA".$CRLF); 
	$temp= fgets($fp,512);  
	$subject="Subject:刘巧的PHP测试邮件".$CRLF;  

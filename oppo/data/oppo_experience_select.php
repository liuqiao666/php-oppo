...
//SQL1: 查询总的记录数量
$sql = "SELECT COUNT(*) FROM oppo_address";
	if(isset($_POST['search']))
	{
			$sql="select *from oppo_address where store =".$_POST['select']."";
	}
...
$sql = "SELECT * FROM oppo_address LIMIT $start, $count";
$result = mysqli_query($conn,$sql);
